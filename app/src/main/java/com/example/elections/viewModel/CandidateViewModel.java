...
public class CandidateViewModel extends ViewModel {
    ...
    public void addNewCandidate(String candidate_name, int governorate_position, int dayra_number, String candidate_pass) {
        repository.add_Candidate(governorate_position, candidate_name, dayra_number, candidate_pass);
    }
}
