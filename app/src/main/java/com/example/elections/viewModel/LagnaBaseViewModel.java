...
public class LagnaBaseViewModel extends ViewModel implements ResultOfLogin {
    ...
    @Override
    public void checkLoginLagna(int governrate,String daira, String qesm, String school, String lagna, String mandoop_pass) {
        repository.checkLoginLagna(governrate, daira, qesm, school, lagna, mandoop_pass, this);
    }
}