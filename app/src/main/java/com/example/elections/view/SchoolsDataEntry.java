        ...
        findViewById(R.id.add).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (school_name.getText().toString().length() > 0 && school_num.getText().toString().length() > 0 && dayra_num.getText().toString().length() > 0 &&
                        ...
                        && lagan_num.getText().toString().length() > 0 && from.getText().toString().length() > 0
                        && to.getText().toString().length() > 0) {
                    ...
                    ,Integer.parseInt(from.getText().toString()),Integer.parseInt(to.getText().toString()));
