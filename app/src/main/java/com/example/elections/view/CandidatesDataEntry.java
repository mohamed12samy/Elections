    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.add).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (candidate_name.getText().toString().length() > 0 && dayra_num.getText().toString().length() > 0) {
                    viewModel.addNewCandidate(candidate_name.getText().toString(), spinner.getSelectedItemPosition() + 1, Integer.parseInt(dayra_num.getText().toString()));
